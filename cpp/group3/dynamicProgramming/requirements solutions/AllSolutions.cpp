...
long long AllSolutions::fibonacci(int a, std::vector<std::pair<int, long long>>& holder) {
...
long long AllSolutions::gridTraveler(int n, int m, std::vector<std::tuple<int, int, long long>>& holder) {
	for(int i = 0; i < holder.size(); i++) {
...
bool AllSolutions::canSum(int targetSum, std::vector<int> numbers, std::vector<std::pair<int, bool>>& holder) {
	for(auto a : holder)
